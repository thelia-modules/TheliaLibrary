...
import React10, { forwardRef as forwardRef2, Fragment as Fragment3, useCallback, useEffect, useImperativeHandle, useMemo, useReducer, useRef } from "react";
...
var Dropzone = /* @__PURE__ */ forwardRef2(function(_ref, ref) {
  ...
  return /* @__PURE__ */ React10.createElement(Fragment3, null, children(_objectSpread2(_objectSpread2({}, props), {}, {
    open
  })));
});
...
var defaultContext = /* @__PURE__ */ React11.createContext(void 0);
var QueryClientSharingContext = /* @__PURE__ */ React11.createContext(false);
...
var useQueryClient = function useQueryClient2() {
  var queryClient3 = React11.useContext(getQueryClientContext(React11.useContext(QueryClientSharingContext)));
  if (!queryClient3) {
...
var QueryClientProvider = function QueryClientProvider2(_ref) {
  ...
  return /* @__PURE__ */ React11.createElement(QueryClientSharingContext.Provider, {
    value: contextSharing
  }, /* @__PURE__ */ React11.createElement(Context2.Provider, {
    value: client
  }, children));
};
...
var QueryErrorResetBoundaryContext = /* @__PURE__ */ React12.createContext(createValue());
var useQueryErrorResetBoundary = function useQueryErrorResetBoundary2() {
  return React12.useContext(QueryErrorResetBoundaryContext);
};
...
function useMutation(arg1, arg2, arg3) {
  var mountedRef = React13.useRef(false);
  var _React$useState = React13.useState(0), forceUpdate = _React$useState[1];
  var options = parseMutationArgs(arg1, arg2, arg3);
  var queryClient3 = useQueryClient();
  var obsRef = React13.useRef();
  if (!obsRef.current) {
    obsRef.current = new MutationObserver(queryClient3, options);
  } else {
  ...
  var mutate = React13.useCallback(function(variables, mutateOptions) {
...
function useBaseQuery(options, Observer) {
  var mountedRef = React14.useRef(false);
  var _React$useState = React14.useState(0), forceUpdate = _React$useState[1];
  var queryClient3 = useQueryClient();
  var errorResetBoundary = useQueryErrorResetBoundary();
  var defaultedOptions = queryClient3.defaultQueryObserverOptions(options);
  ...
  var _React$useState2 = React14.useState(function() {
    return new Observer(queryClient3, defaultedOptions);
...
import { Suspense, useContext as useContext2, useState as useState2 } from "react";
...
import React18, { useLayoutEffect, useEffect as useEffect2, useRef as useRef2, useState, cloneElement, useMemo as useMemo2, forwardRef as forwardRef$1 } from "react";
...
var useIsomorphicLayoutEffect = isBrowser2 ? useLayoutEffect : useEffect2;
...
function TippyGenerator(tippy2) {
  function Tippy(_ref) {
    ...
    return /* @__PURE__ */ React18.createElement(React18.Fragment, null, children ? /* @__PURE__ */ cloneElement(children, {
...
var forwardRef3 = function(Tippy, defaultProps3) {
  return /* @__PURE__ */ forwardRef$1(function TippyWrapper(_ref, _ref2) {
    ...
    return /* @__PURE__ */ React18.createElement(Tippy, Object.assign({}, defaultProps3, props), children ? /* @__PURE__ */ cloneElement(children, {
      ref: function ref(node) {
...
var TagConfigurationModal = ({
  ...
  const [showTags, setShowTags] = useState2(false);
  const intl = useIntl();
...
var LibraryImage = ({
  ...
  const [isTagModalOpen, setIsTagModalOpen] = useState2(false);
  const intl = useIntl();
  const deleteMutation = useDeleteImage();
  const { getUrlWithPrefix } = useContext2(LocaleContext);
...
var LibraryContent = ({
  ...
  const [offset2, setOffset] = useState2(0);
  const [title, setTitle] = useState2("");
  const [tagId, setTagId] = useState2();
  const {
    data: images = [],
    isFetching,
    isPreviousData
...
function Library({
  ...
  const intl = useIntl();
  const [mode, setMode] = useState2("library");
  return /* @__PURE__ */ React.createElement(import_react_modal.default, {
    isOpen,
    ...
    className: "Modal__Content"
  }, mode === "library" ? /* @__PURE__ */ React.createElement(Suspense, {
    fallback: /* @__PURE__ */ React.createElement("div", {
      className: "Modal__Content__Loader"
...
import { useEffect as W, useState as j2 } from "react";
...
var FromLocal = ({
  ...
  const { getRootProps, isDragActive } = useDropzone({
    ...
    onDropRejected: (rejectedFiles) => {
      rejectedFiles.length > 1 ? n2.error(intl.formatMessage({ id: "BlockImage__TOAST_MAX_FILE" })) : n2.error(
...
var Preview = ({
  ...
  const intl = useIntl();
  const { getUrlWithPrefix } = useContext3(LocaleContext2);
  if (!id)
    return null;
  return /* @__PURE__ */ React.createElement("div", {
...
var BlockImageComponent = (props) => {
  ...
  const [isEditMode, setEditMode] = useState3(false);
  const intl = useIntl();
  useEffect3(() => {
    if (data.id) {
      setImage(data);
